...
private _randomColorR = sliderPosition (_display displayCtrl SQFLAB_IDC_SLIDER_RANDOM_COLOR_R);
...
private _randomColorVar = [_randomColorR, _randomColorG, _randomColorB, _randomColorA];
