...
private _sliderDefaults = createHashMapFromArray [
	...
	[SQFLAB_IDC_SLIDER_EMISSIVE_R, 0],
	[SQFLAB_IDC_SLIDER_EMISSIVE_G, 0],
	[SQFLAB_IDC_SLIDER_EMISSIVE_B, 0],
	[SQFLAB_IDC_SLIDER_EMISSIVE_A, 0]
];
...
private _sliderRanges = [
	...
	[SQFLAB_IDC_SLIDER_EMISSIVE_R, 0, 1],
	[SQFLAB_IDC_SLIDER_EMISSIVE_G, 0, 1],
	[SQFLAB_IDC_SLIDER_EMISSIVE_B, 0, 1],
	[SQFLAB_IDC_SLIDER_EMISSIVE_A, 0, 1]
];
